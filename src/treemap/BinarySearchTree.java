								...
								implements MyTreeMap<AnyType, AnyValue>
{
    ...
    /** The tree root. */
    private BinaryNode<AnyType, AnyValue> root;
     ...
     */
    private BinaryNode<AnyType, AnyValue> insert( AnyType x, AnyValue y, BinaryNode<AnyType, AnyValue> t )
    {
    	while( t != null ) {
     ...
     */
    private BinaryNode<AnyType, AnyValue> remove( AnyType x, BinaryNode<AnyType, AnyValue> t )
    {
        if( t == null )
     ...
     */
    private BinaryNode<AnyType, AnyValue> removeMin( BinaryNode<AnyType, AnyValue> t )
    {
        if( t == null )
     ...
     */
    private BinaryNode<AnyType, AnyValue> findMin( BinaryNode<AnyType, AnyValue> t )
    {
    	if( t != null )
            while( t.left != null )
                t = t.left;
 ...
 // of this package.
    ...
    private static class BinaryNode<AnyType, AnyValue>
    {
         // Constructor
